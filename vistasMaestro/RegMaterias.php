    ...
    if (isset($_SESSION['usuario']) && $_SESSION['tipo'] == 2){
        ...
        if(isset($_GET['buscar'])){
            $buscar=$_GET['buscar'];
                ...
                $rst_horarios= mysqli_query($connect, "SELECT * FROM horario JOIN asignaturas ON horario.asignatura_c = asignaturas.clave JOIN maestros ON horario.maestro_c = maestros.clave_maes JOIN dias ON horario.dia1 = dias.id_dia AND horario.dia2 = dias.id_dia AND horario.dia3 = dias.id_dia AND horario.dia4 = dias.id_dia AND horario.dia5 = dias.id_dia JOIN horas ON horario.hora_c = horas.id_hora JOIN salones ON horario.salon_c = salones.salon WHERE asignatura_c='".$buscar."' OR maestro_c='".$buscar."' OR dia1='".$buscar."' OR dia2='".$buscar."' OR dia3='".$buscar."' OR dia4='".$buscar."' OR dia5='".$buscar."' OR hora_c='".$buscar."' OR salon_c='".$buscar."'") or die ("El query está mal");
                ...
                $query=  mysqli_query($connect, "SELECT * FROM horario JOIN asignaturas ON horario.asignatura_c = asignaturas.clave JOIN maestros ON horario.maestro_c = maestros.clave_maes JOIN dias ON horario.dia1 = dias.id_dia AND horario.dia2 = dias.id_dia AND horario.dia3 = dias.id_dia AND horario.dia4 = dias.id_dia AND horario.dia5 = dias.id_dia JOIN horas ON horario.hora_c = horas.id_hora JOIN salones ON horario.salon_c = salones.salon WHERE asignatura_c='".$buscar."' OR maestro_c='".$buscar."' OR dia1='".$buscar."' OR dia2='".$buscar."' OR dia3='".$buscar."' OR dia4='".$buscar."' OR dia5='".$buscar."' OR hora_c='".$buscar."' OR salon_c='".$buscar."' LIMIT $inicio, $registros");
            
        }else{
            if(empty($_GET['buscar'])){
                $rst_horarios= mysqli_query($connect, "SELECT * FROM horario ORDER BY id");
                $total_registros= mysqli_num_rows($rst_horarios);
                $registros=10;
                $pagina=$_GET['num'];
                if(is_numeric($pagina)){
                ...
                $query=  mysqli_query($connect, "SELECT * FROM horario JOIN asignaturas ON horario.asignatura_c = asignaturas.clave JOIN maestros ON horario.maestro_c = maestros.clave_maes JOIN dias ON horario.dia1 = dias.id_dia AND horario.dia2 = dias.id_dia AND horario.dia3 = dias.id_dia AND horario.dia4 = dias.id_dia AND horario.dia5 = dias.id_dia JOIN horas ON horario.hora_c = horas.id_hora JOIN salones ON horario.salon_c = salones.salon LIMIT $inicio, $registros") or die ("El query esta mal");
            }
        } 
...
<html>
    ...
    <body>
        ...
        <article>
            ...
            <table id="tabla">
                <form name="busca" method="get" action="../vistasAdmin/gestHorarios.php">
                <tr>
